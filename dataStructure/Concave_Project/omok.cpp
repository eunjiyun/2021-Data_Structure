...
void set()
{
	...
	{
		if (attack[3].exist == true && board[attack[3].y][attack[3].x] == '+')//4공격
		{
			board[attack[3].y][attack[3].x] = 'w';
			char recommend = '2';
			if (board[attack[3].y - 1][attack[3].x] == '+' && attack[3].y - 1 < 19 && attack[3].y - 1 >= 0 && attack[3].x >= 0 && attack[3].x < 19)
				board[attack[3].y - 1][attack[3].x] = recommend++;
			if (board[attack[3].y][attack[3].x - 1] == '+' && attack[3].y < 19 && attack[3].y >= 0 && attack[3].x - 1 >= 0 && attack[3].x - 1 < 19)
		...
		else if (defense[3].exist == true && board[defense[3].y][defense[3].x] == '+')//4방어
		{
			board[defense[3].y][defense[3].x] = 'w';
			char recommend = '2';
			if (board[defense[3].y - 1][defense[3].x] == '+' && defense[3].y - 1 < 19 && defense[3].y - 1 >= 0 && defense[3].x >= 0 && defense[3].x < 19)
				board[defense[3].y - 1][defense[3].x] = recommend++;
			if (board[defense[3].y][defense[3].x - 1] == '+' && defense[3].y < 19 && defense[3].y >= 0 && defense[3].x - 1 >= 0 && defense[3].x - 1 < 19)
		...
		else if (attack[2].exist == true && board[attack[2].y][attack[2].x] == '+')//3공격
		{
			...
			char recommend = '2';
			if (board[attack[2].y - 1][attack[2].x] == '+' && attack[2].y - 1 < 19 && attack[2].y - 1 >= 0 && attack[2].x >= 0 && attack[2].x < 19)
				board[attack[2].y - 1][attack[2].x] = recommend++;
			if (board[attack[2].y][attack[2].x - 1] == '+' && attack[2].y < 19 && attack[2].y >= 0 && attack[2].x - 1 >= 0 && attack[2].x - 1 < 19)
		...
		else if (defense[2].exist == true && board[defense[2].y][defense[2].x] == '+')//3방어
		{
			...
			char recommend = '2';
			if (board[defense[2].y - 1][defense[2].x] == '+' && defense[2].y - 1 < 19 && defense[2].y - 1 >= 0 && defense[2].x >= 0 && defense[2].x < 19)
				board[defense[2].y - 1][defense[2].x] = recommend++;
			if (board[defense[2].y][defense[2].x - 1] == '+' && defense[2].y < 19 && defense[2].y >= 0 && defense[2].x - 1 >= 0 && defense[2].x - 1 < 19)
		...
		else if (attack[1].exist == true && board[attack[1].y][attack[1].x] == '+')//2공격
		{
			...
			char recommend = '2';
			if (board[attack[1].y - 1][attack[1].x] == '+' && attack[1].y - 1 < 19 && attack[1].y - 1 >= 0 && attack[1].x >= 0 && attack[1].x < 19)
				board[attack[1].y - 1][attack[1].x] = recommend++;
			if (board[attack[1].y][attack[1].x - 1] == '+' && attack[1].y < 19 && attack[1].y >= 0 && attack[1].x - 1 >= 0 && attack[1].x - 1 < 19)
		...
		else if (attack[0].exist == true && board[attack[0].y][attack[0].x] == '+')//1공격
		{
			...
			char recommend = '2';
			if (board[attack[0].y - 1][attack[0].x] == '+' && attack[0].y - 1 < 19 && attack[0].y - 1 >= 0 && attack[0].x >= 0 && attack[0].x < 19)
				board[attack[0].y - 1][attack[0].x] = recommend++;
			if (board[attack[0].y][attack[0].x - 1] == '+' && attack[0].y < 19 && attack[0].y >= 0 && attack[0].x - 1 >= 0 && attack[0].x - 1 < 19)
